...
I verified the image in Docker Desktop and successfully pushed it to my public Docker Hub registry registry.
...
To simulate a clean deployment, I deleted the local image from my computer, pulled it fresh from Docker Hub, and verified it was downloaded.
